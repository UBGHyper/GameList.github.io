;(() => {
  ...
  const g = JSON.parse('{"rE":"0.5.1","l$":{"r":2,"M":4}}')
  const x = g.l$.r
  ...
  function C (e) {
    if (null == E) {
      ...
      ;(t.className = 'version'),
        (t.textContent = 'Version: ' + b),
        e.appendChild(t)
      const r = document.createElement('div')
      ;(r.className = 'user-agent'),
        (r.textContent = 'User Agent: ' + navigator.userAgent),
        e.appendChild(r)
      const o = document.createElement('textarea')
      ;(o.readOnly = !0), e.appendChild(o), (E = { element: e, textArea: o })
    }
    E.textArea.value = e + '\n' + E.textArea.value
  }
